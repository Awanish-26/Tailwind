...
function replaceImage() {
  ...
  var newImageSrc;
  if (deviceWidth < 600) {
    image.setAttribute('src',"../images/dmitriy-nushtaev-circle.jpg");
    image2.setAttribute('src',"../images/charlie-green-circle.jpg");
    image3.setAttribute('src',"../images/omar-lopez-circle.jpg");
    ...
    image.setAttribute ('src','../images/dmitriy-nushtaev-tyv3bhizAx8-unsplash(1).jpg');
    image2.setAttribute ('src','../images/charlie-green-3JmfENcL24M-unsplash.jpg');
    image3.setAttribute ('src','../images/omar-lopez-Gx5-zf_HE9w-unsplash.jpg');
